...
class DinoVisionTransformer(nn.Module):
    def __init__(
        ...
        assert num_register_tokens >= 0, "num_register_tokens should be non-negative"
    ...
    def interpolate_pos_encoding(self, x, w, h):
        ...
        # w0, h0 = w0 + 0.1, h0 + 0.1
        M = int(math.sqrt(N))
        assert N == M * M, "pos_embed has incorrect size"
        kwargs = {}
    ...
    def forward_features(self, x, masks=None):
        ...
        return {
            ...
            "x_norm_regtokens": x_norm[:, 1:self.num_register_tokens+1],
            "x_norm_patchtokens": x_norm[:, self.num_register_tokens+1:],
            "x_norm_patchtokens_mid4": x_mid4[:, self.num_register_tokens+1:],
            "x_prenorm": x,
            "masks": masks,
        }
...
def vit_small(patch_size=14, num_register_tokens=0, img_size=140, **kwargs):
